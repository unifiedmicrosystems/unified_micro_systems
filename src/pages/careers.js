          ...
          <form name="application_form" method="POST" data-netlify="true" data-netlify-honeypot="bot-field">
              ...
              <p>
                ...
                <span className="country comn-select">
                  <select name="country" className="form-select" aria-invalid="false"><option value="-----">-----</option>
            ...
            <p>
              ...
              <span className="notice-period comn-select">
                <select name="notice-period" className="wpcf7-form-control wpcf7-select" aria-invalid=  "false"><option value="Immediate">Immediate</option><option value="2 weeks">2 weeks</option><option value="1 month">1 month</option><option value="3 months">3 months</option></select></span> 
                </label>
            </p>
            <p className="cv-doc">
              <label> CV (.pdf, .doc, .docx)<br />
              <span className="CV"><input type="file" name="CV" size="40" className="" accept=".pdf,.doc,.docx" aria-required="true" aria-invalid="false" /></span> </label></p>
